...
#The Credit For This Code Goes To KARTIK & DHADKAN
...
KARTIK DON OF NEPAL ⏏️⏏️

NEPALI FYTER AND TRICKER

WE NEVER FORGIVE AND NEVER FORGET

NEPALI ANONYMOUS CRACKERS
...
In many cases (such as GMail) you can simply copy the above color faded text and paste it into your destination. If you cannot, copy and use the color code below.
  ...
  \033[1;91m:》》》\033[1;93m+9779742828627\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::

\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-KARTIKXDHADKAN-\033[1;95m♡╭──────────•◈•──────────╮♡

\033[1;92m..........................KARTIKXDHADKAN......................

\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗

\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   KARTIK X DHADKAN

\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mKARTIKXDHADKAN\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
* ¸¸¸¸*__________________________* ¸¸¸¸*«┈┈┈┈┈┈┈┈┈         
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  ...
  \033[1;96m ─────────────•◈•──────────  
   ...
   \033[1;92m███████▒▒Welcome To DHADKAN X KARTHIK HACKERS ORG▒▒████████

\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mN00BHackerS\033[1;95m♡╭──────────•◈•──────────╮♡

\033[1;94mAuthor\033[1;91m: \033[1;91mKARTIK-DON

\033[1;94m...005492\033[1;91m: \033[1;91▒▓██████████████]100.%

\033[1;94mFacebook\033[1;91m: \033[1;91mDHADKAN.IO

\033[1;94mWhatsapp\033[1;91m: \033[1;91m+9779742828627

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mKARTIK...DON\033[1;95m♡╰──────────•◈•──────────╯♡"""

jalan('              \033[1;96m.................... ONLY FOR EDUCATIONAL PURPOSE.....................:')
...
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin N00BHackers\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "KARTHIK-403"

CorrectPassword = "DHADKAN-403"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:KARTIK_hacker
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKARTIKEEYY\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKARTIK-DON\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mkarthikHacker-403mDhadkanHacker-404\033\033[1;95m♡──────────•◈•──────────♡"
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKARTHIKhacker\033[1;95m♡──────────•◈•──────────╯♡"
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKARTIK-DON X DHADKAN\033[1;95m♡──────────•◈•──────────♡"
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mKARTIK-DON X DHADKAN XAKKA\033[1;95m♡──────────•◈•──────────♡"

	print "  \033[1;93m«---•◈•---Developed By Baloch---•◈•---»" #Dev: KARTHIK-DON X DHADKAN-XAKKA
...
: \033[1;96m ..... KARTIK DON DHADKAN KHANAL........... \033[1;93m :
